...
@Component
public class JobCrawl extends AbstractCrawl<JobCrawl.Item> {
  ...
  public JobCrawl(String keyword, JobRepository jobRepository) {
    setComparator(comparator);
    this.keyword = keyword;
    this.jobRepository = jobRepository;
  }
  ...
  private String getJobDetail (String url) {
    Document doc = null;
    doc = Jsoup.parse(String.valueOf(downloadHtml(url, "gb2312")));
  ...
  @Override
  public void save2DB() {
    for(JobCrawl.Item item : getTotal()) {
